...
final class ConnectionBDD {
     ...
     *            the new instance
     */
    private static void setInstance(final ConnectionBDD instance) {
        ConnectionBDD.instance = instance;
    }
    ...
    private boolean open() {
        try {
            this.connection = DriverManager.getConnection(ConnectionBDD.url, ConnectionBDD.user,
                    ConnectionBDD.password);
