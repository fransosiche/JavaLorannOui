...
abstract class mobil extends Element implements IMobil {
	 ...
	 *            the permeability
	 */
	mobil(final Sprite sprite, final Permeability permeability) {
	 ...
	 *            the permeability
	 */
	mobil(final int x, final int y, final Sprite sprite, final Permeability permeability) {
